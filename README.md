...
只需开启无障碍服务即可使用，适合大多数场景。

**配置步骤：**
1. 打开 AutoZi 设置
2. 点击"无障碍服务" → 找到 AutoZi → 开启
...
3. **验证配置**
   - 打开 AutoZi 设置页
   - 确认显示"当前输入方式：Shizuku + ADB Keyboard（推荐）"

**适用场景：** 微信、支付宝等对无障碍限制严格的应用
